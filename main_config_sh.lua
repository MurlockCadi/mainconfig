...
DivisionTypes = {
    ...
    ["High Command"] = {
        ...
        VIP = true,
        Ranks = {
            {ID = 1, Name = "Contracted Mercenary", Rank_Prefix = "", ModelsAllowed = MERC_MODELS, WeaponsAllowed = {}, CanPromote = false},
        },
        Classes = {
            {
...
FACTION_TYPES["CHAOS_DWARFS"] = {
    ...
    CreateDwarfs = function(self, bot, elite)
		...
		elseif roll <= 55 then
            ...
            bot:SetModel("models/dizcordum/wk/dizcordum/inq/godrik_minotaur_khorne.mdl")
            bot.FightType = "melee"
            bot.weapon = "cat_chaos_legacy_powerbattleaxe"
            bot:SetRunSpeed(200)
            bot:SetWalkSpeed(200)

...
DivisionTypes = {
    ["Cult Mechanicus Conclave"] = {
        ...
        Team = "imperium",
        Ranks = {
            {ID = 1, Name = "Admech", Rank_Prefix = "Mech Wright", ModelsAllowed = ADMECH_MODELS, WeaponsAllowed = ADMECH_WEAPONS, CanPromote = true},
			{ID = 2, Name = "Admech", Rank_Prefix = "Acuitor Silica", ModelsAllowed = ADMECH_MODELS, WeaponsAllowed = ADMECH_WEAPONS, CanPromote = true},
			{ID = 3, Name = "Admech", Rank_Prefix = "Datasmith", ModelsAllowed = ADMECH_MODELS, WeaponsAllowed = ADMECH_WEAPONS, CanPromote = true},
			{ID = 4, Name = "Admech", Rank_Prefix = "Mech Lord", ModelsAllowed = ADMECH_MODELS, WeaponsAllowed = ADMECH_WEAPONS, CanPromote = true},
			{ID = 5, Name = "Admech", Rank_Prefix = "Cybernetican Major", ModelsAllowed = ADMECH_MODELS, WeaponsAllowed = ADMECH_WEAPONS, CanPromote = true},
			{ID = 6, Name = "Admech", Rank_Prefix = "Cybersmith", ModelsAllowed = ADMECH_MODELS, WeaponsAllowed = ADMECH_WEAPONS, CanPromote = true},
			{ID = 7, Name = "Admech", Rank_Prefix = "Fabricator Architect", ModelsAllowed = ADMECH_MODELS, WeaponsAllowed = ADMECH_WEAPONS, CanPromote = true},
			{ID = 8, Name = "Admech", Rank_Prefix = "Artisan", ModelsAllowed = ADMECH_MODELS, WeaponsAllowed = ADMECH_WEAPONS, CanPromote = true},
			{ID = 9, Name = "Admech", Rank_Prefix = "Master Artisan", ModelsAllowed = ADMECH_MODELS, WeaponsAllowed = ADMECH_WEAPONS, CanPromote = true},
			{ID = 10, Name = "Admech", Rank_Prefix = "Artisan Supreme", ModelsAllowed = ADMECH_MODELS, WeaponsAllowed = ADMECH_WEAPONS, CanPromote = true},
			{ID = 11, Name = "Admech", Rank_Prefix = "Technomancer", ModelsAllowed = ADMECH_MODELS, WeaponsAllowed = ADMECH_WEAPONS, CanPromote = true},
			{ID = 12, Name = "Admech", Rank_Prefix = "Technomancer-At-Arms", ModelsAllowed = ADMECH_MODELS, WeaponsAllowed = ADMECH_WEAPONS, CanPromote = true},
			{ID = 13, Name = "Admech", Rank_Prefix = "Biologist", ModelsAllowed = ADMECH_MODELS, WeaponsAllowed = ADMECH_WEAPONS, CanPromote = true},
			{ID = 14, Name = "Admech", Rank_Prefix = "Cheif Biologis", ModelsAllowed = ADMECH_MODELS, WeaponsAllowed = ADMECH_WEAPONS, CanPromote = true},
			{ID = 15, Name = "Admech", Rank_Prefix = "Biologis Major", ModelsAllowed = ADMECH_MODELS, WeaponsAllowed = ADMECH_WEAPONS, CanPromote = true},
			{ID = 16, Name = "Admech", Rank_Prefix = "Arch Magos", ModelsAllowed = ADMECH_MODELS, WeaponsAllowed = ADMECH_WEAPONS, CanPromote = true},
        },
        Classes = {
            {
                Name = "Logis",

...
DivisionTypes = {
    ["Commonwelth Division"] = {
        ...
        Ranks = {
            {ID = 1, Name = "Private", Rank_Prefix = "PVT", ModelsAllowed = BRITISH_MODELS, WeaponsAllowed = BRITISH_LOADOUT},
            {ID = 2, Name = "Lance Corporal", Rank_Prefix = "LCPL", ModelsAllowed = BRITISH_MODELS, WeaponsAllowed = BRITISH_LOADOUT},
            {ID = 3, Name = "Corporal", Rank_Prefix = "CPL", ModelsAllowed = BRITISH_MODELS, WeaponsAllowed = BRITISH_LOADOUT},
            {ID = 4, Name = "Sergeant", Rank_Prefix = "SGT", ModelsAllowed = BRITISH_MODELS, WeaponsAllowed = BRITISH_LOADOUT},
            {ID = 5, Name = "Staff Sergeant", Rank_Prefix = "SSGT", ModelsAllowed = BRITISH_MODELS, WeaponsAllowed = BRITISH_LOADOUT},
            {ID = 6, Name = "Platoon Sergeant Major", Rank_Prefix = "PSM", ModelsAllowed = BRITISH_MODELS, WeaponsAllowed = BRITISH_LOADOUT},
            {ID = 7, Name = "Company Sergeant Major", Rank_Prefix = "CSM", ModelsAllowed = BRITISH_MODELS, WeaponsAllowed = BRITISH_LOADOUT},
            {ID = 8, Name = "Regiment Sergeant Major", Rank_Prefix = "RSM", ModelsAllowed = BRITISH_MODELS, WeaponsAllowed = BRITISH_LOADOUT},
    ...
    ["US Division"] = {
        ...
        Ranks = {
            ...
            {ID = 4, Name = "Technical Corporal", Rank_Prefix = "TCPL", ModelsAllowed = US_NCO_MODELS, WeaponsAllowed = US_LOADOUT},

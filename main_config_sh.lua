...
ARBITES_MODELS = {"models/wk/arbitr/wk_arbites.mdl"}
--KRIEG
...
SQUAT_MODELS = {"models/knight_ig/muschi_ig_squat.mdl","models/muschi/knight_ig/muschi_ig_squat.mdl","models/muschi/knight_ig/muschi_ig_squat_kalt.mdl","models/knight_ig/muschi_ig_squat_kalt.mdl"}

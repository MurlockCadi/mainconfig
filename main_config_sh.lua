...
DivisionTypes = {
    ...
    ["US Division"] = {
        ...
        Ranks = {
            ...
            {ID = 3, Name = "Corporal", Rank_Prefix = "CPL", ModelsAllowed = US_NCO_MODELS, WeaponsAllowed = US_LOADOUT},
            {ID = 4, Name = "Sergeant", Rank_Prefix = "SGT", ModelsAllowed = US_NCO_MODELS, WeaponsAllowed = US_LOADOUT},
            {ID = 5, Name = "Staff Sergeant", Rank_Prefix = "SSG", ModelsAllowed = US_NCO_MODELS, WeaponsAllowed = US_LOADOUT},
            {ID = 6, Name = "First Sergeant", Rank_Prefix = "1SG", ModelsAllowed = US_NCO_MODELS, WeaponsAllowed = US_LOADOUT},
            {ID = 7, Name = "Sergeant Major", Rank_Prefix = "SGM", ModelsAllowed = US_NCO_MODELS, WeaponsAllowed = US_LOADOUT},
            {ID = 8, Name = "Second Lieutenant", Rank_Prefix = "2LT", ModelsAllowed = US_CO_MODEL, WeaponsAllowed = US_LOADOUT},
            {ID = 9, Name = "First Lieutenant", Rank_Prefix = "1LT", ModelsAllowed = US_CO_MODEL, WeaponsAllowed = US_LOADOUT},
            {ID = 10, Name = "Captain", Rank_Prefix = "CPT", ModelsAllowed = US_CO_MODEL, WeaponsAllowed = US_LOADOUT},
            {ID = 11, Name = "Major", Rank_Prefix = "MAJ", ModelsAllowed = US_CO_MODEL, WeaponsAllowed = US_LOADOUT},
            {ID = 12, Name = "Lieutenant Colonel", Rank_Prefix = "LTC", ModelsAllowed = US_CO_MODEL, WeaponsAllowed = US_LOADOUT},
            {ID = 13, Name = "Colonel", Rank_Prefix = "COL", ModelsAllowed = US_CO_MODEL, WeaponsAllowed = US_LOADOUT},
        },
        Classes = {
            {
                Name = "Rifleman",
    ...
    ["Wehrmacht Division"] = {
        ...
        Ranks = {
            {ID = 1, Name = "Rekrut", Rank_Prefix = "RKT", ModelsAllowed = DE_ENLISTED_MODELS, WeaponsAllowed = DE_LOADOUT},
            {ID = 2, Name = "Soldat", Rank_Prefix = "SDT", ModelsAllowed = DE_ENLISTED_MODELS, WeaponsAllowed = DE_LOADOUT},
            ...
            {ID = 5, Name = "Unteroffizier", Rank_Prefix = "UO", ModelsAllowed = DE_NCO_MODELS, WeaponsAllowed = DE_LOADOUT},
            {ID = 6, Name = "Feldwebel", Rank_Prefix = "FW", ModelsAllowed = DE_NCO_MODELS, WeaponsAllowed = DE_LOADOUT},
            {ID = 7, Name = "Oberfeldwebel", Rank_Prefix = "OFW", ModelsAllowed = DE_NCO_MODELS, WeaponsAllowed = DE_LOADOUT},
            {ID = 8, Name = "Leutnant", Rank_Prefix = "LT", ModelsAllowed = DE_CO_MODELS, WeaponsAllowed = DE_LOADOUT},
            {ID = 9, Name = "Oberleutnant", Rank_Prefix = "OLT", ModelsAllowed = DE_CO_MODELS, WeaponsAllowed = DE_LOADOUT},
            {ID = 10, Name = "Hauptmann", Rank_Prefix = "HPT", ModelsAllowed = DE_CO_MODELS, WeaponsAllowed = DE_LOADOUT},
            {ID = 11, Name = "Major", Rank_Prefix = "MAJ", ModelsAllowed = DE_CO_MODELS, WeaponsAllowed = DE_LOADOUT},
            {ID = 12, Name = "Oberstleutnant", Rank_Prefix = "OLT", ModelsAllowed = DE_CO_MODELS, WeaponsAllowed = DE_LOADOUT},
            {ID = 13, Name = "Oberst", Rank_Prefix = "OBT", ModelsAllowed = DE_CO_MODELS, WeaponsAllowed = DE_LOADOUT},
        },
        Classes = {
            {
                Name = "Rifleman",
    ...
    ["Fallschirmjäger Division"] = {
        ...
        Description = "GOTT MIT UNS! The Wehrmacht is the backbone of the German Army, with millions of soldiers fighting for the Fatherland. The Wehrmacht is known for its discipline, tactics, and ideological fervor.",
        Ranks = {
            {ID = 1, Name = "Rekrut", Rank_Prefix = "RKT", ModelsAllowed = FM_MODELS, WeaponsAllowed = FM_LOADOUT},
            {ID = 2, Name = "Soldat", Rank_Prefix = "SDT", ModelsAllowed = FM_MODELS, WeaponsAllowed = FM_LOADOUT},
            {ID = 3, Name = "Gefreiter", Rank_Prefix = "GFR", ModelsAllowed = FM_MODELS, WeaponsAllowed = FM_LOADOUT},
            {ID = 4, Name = "Obergefreiter", Rank_Prefix = "OGFR", ModelsAllowed = FM_MODELS, WeaponsAllowed = FM_LOADOUT},
            {ID = 5, Name = "Unteroffizier", Rank_Prefix = "UO", ModelsAllowed = FM_MODELS, WeaponsAllowed = FM_LOADOUT},
            {ID = 6, Name = "Feldwebel", Rank_Prefix = "FW", ModelsAllowed = FM_MODELS, WeaponsAllowed = FM_LOADOUT},
            {ID = 7, Name = "Oberfeldwebel", Rank_Prefix = "OFW", ModelsAllowed = FM_MODELS, WeaponsAllowed = FM_LOADOUT},
            {ID = 8, Name = "Leutnant", Rank_Prefix = "LT", ModelsAllowed = FM_CO_MODELS, WeaponsAllowed = FM_LOADOUT},
            {ID = 9, Name = "Oberleutnant", Rank_Prefix = "OLT", ModelsAllowed = FM_CO_MODELS, WeaponsAllowed = FM_LOADOUT},
            {ID = 10, Name = "Hauptmann", Rank_Prefix = "HPT", ModelsAllowed = FM_CO_MODELS, WeaponsAllowed = FM_LOADOUT},
            {ID = 11, Name = "Major", Rank_Prefix = "MAJ", ModelsAllowed = FM_CO_MODELS, WeaponsAllowed = FM_LOADOUT},
            {ID = 12, Name = "Oberstleutnant", Rank_Prefix = "OLT", ModelsAllowed = FM_CO_MODELS, WeaponsAllowed = FM_LOADOUT},
            {ID = 13, Name = "Oberst", Rank_Prefix = "OBT", ModelsAllowed = FM_CO_MODELS, WeaponsAllowed = FM_LOADOUT},
        },
        Classes = {
            {
                Name = "Rifleman",
    ...
    ["US Airborne Division"] = {
        ...
        Ranks = {
            ...
            {ID = 3, Name = "Corporal", Rank_Prefix = "CPL", ModelsAllowed = AIRBORN_MODELS, WeaponsAllowed = AIRBORN_LOADOUT},
            {ID = 4, Name = "Sergeant", Rank_Prefix = "SGT", ModelsAllowed = AIRBORN_MODELS, WeaponsAllowed = AIRBORN_LOADOUT},
            {ID = 5, Name = "Staff Sergeant", Rank_Prefix = "SSG", ModelsAllowed = AIRBORN_MODELS, WeaponsAllowed = AIRBORN_LOADOUT},
            {ID = 6, Name = "First Sergeant", Rank_Prefix = "1SG", ModelsAllowed = AIRBORN_MODELS, WeaponsAllowed = AIRBORN_LOADOUT},
            {ID = 7, Name = "Sergeant Major", Rank_Prefix = "SGM", ModelsAllowed = AIRBORN_MODELS, WeaponsAllowed = AIRBORN_LOADOUT},
            {ID = 8, Name = "Second Lieutenant", Rank_Prefix = "2LT", ModelsAllowed = AIRBORN_MODELS, WeaponsAllowed = AIRBORN_LOADOUT},
            {ID = 9, Name = "First Lieutenant", Rank_Prefix = "1LT", ModelsAllowed = AIRBORN_MODELS, WeaponsAllowed = AIRBORN_LOADOUT},
            {ID = 10, Name = "Captain", Rank_Prefix = "CPT", ModelsAllowed = AIRBORN_MODELS, WeaponsAllowed = AIRBORN_LOADOUT},
            {ID = 11, Name = "Major", Rank_Prefix = "MAJ", ModelsAllowed = AIRBORN_MODELS, WeaponsAllowed = AIRBORN_LOADOUT},
            {ID = 12, Name = "Lieutenant Colonel", Rank_Prefix = "LTC", ModelsAllowed = AIRBORN_MODELS, WeaponsAllowed = AIRBORN_LOADOUT},
            {ID = 13, Name = "Colonel", Rank_Prefix = "COL", ModelsAllowed = AIRBORN_MODELS, WeaponsAllowed = AIRBORN_LOADOUT},
        },
        Classes = {
            {
                Name = "Rifleman",

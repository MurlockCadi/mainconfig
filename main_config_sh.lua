...
helpTopics = {
    ["Intro"] = "Welcome to Imperium Gaming's Cold War RP!\n\nThis server runs our custom ImperiumRP gamemode—designed from the ground up for an immersive, player-driven MRP experience. No Nutscript clones or DarkRP reskins here! This is the unique MRP server you've been searching for.\n\nThis Help Menu will guide you through the server's features, gameplay, and custom content. Need to reopen this menu? Type /help in chat anytime! Select a topic on the right to learn more.\n\nGetting Started:\n\nYou've created a character and chosen your side—great start! Now, join your first Division. Divisions are fully player-controlled and managed in-game. Any player can create one and can unlock classes, ranks, and upgrades for it! For now, we recommend joining an existing Division to access their custom classes, rank up, and learn the ropes.",

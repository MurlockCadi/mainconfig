...
commands = {
	...
	["!suspect"] = function(ply) OpenURL(ply,"https://docs.google.com/document/d/1pwQfOAKdbcFL2ROXF6BQkQtxZ8OoO_3jTvkxwky1W-M/edit?usp=sharing") end,
	["/krieg"] = function(ply) OpenURL(ply,"https://docs.google.com/document/d/1gDxdu597nVkg5XScYwSIjJsQ953yH5eHydqyM62usM8/edit?usp=sharing") end,
	["!krieg"] = function(ply) OpenURL(ply,"https://docs.google.com/document/d/1gDxdu597nVkg5XScYwSIjJsQ953yH5eHydqyM62usM8/edit?usp=sharing") end,
	["/cadia"] = function(ply) OpenURL(ply,"https://docs.google.com/document/d/1c9ZQRq2qMvx5LlX3aOleR3MZLBXtZ3PkEM6TzSvB87k/edit?tab=t.4933skickrdw") end,
	["!cadia"] = function(ply) OpenURL(ply,"https://docs.google.com/document/d/1c9ZQRq2qMvx5LlX3aOleR3MZLBXtZ3PkEM6TzSvB87k/edit?tab=t.4933skickrdw") end,
	...
	["!ranks"] = function(ply) OpenURL(ply,"https://docs.google.com/presentation/d/1X0jWf914SPy8XZarTeDKJJ7BzXO_XUEBgAKFA99huCk/edit?slide=id.g3cccb033dcc_0_112#slide=id.g3cccb033dcc_0_112") end,
	["!weapons"] = function(ply) OpenURL(ply,"https://docs.google.com/spreadsheets/d/1Lv5hVzNLXHPbqqCNbK9hclmOu7heYzFw5LvbqDMqD_U/edit?usp=sharing") end,
	["/weapons"] = function(ply) OpenURL(ply,"https://docs.google.com/spreadsheets/d/1Lv5hVzNLXHPbqqCNbK9hclmOu7heYzFw5LvbqDMqD_U/edit?usp=sharing") end,
	...
	["/scarus"] = function(ply) OpenURL(ply,"https://www.imperiumgaming.net/scarus-sector") end,
	["!roster"] = function(ply) OpenURL(ply,"https://docs.google.com/spreadsheets/d/12bVhYKzwn4M0TMgrOMc7a9bWe6zFVAzbjsIeFuW2_IY/edit?usp=sharing") end,
	["/roster"] = function(ply) OpenURL(ply,"https://docs.google.com/spreadsheets/d/12bVhYKzwn4M0TMgrOMc7a9bWe6zFVAzbjsIeFuW2_IY/edit?usp=sharing") end,
	["!cert"] = function(ply) OpenURL(ply,"https://docs.google.com/spreadsheets/d/12bVhYKzwn4M0TMgrOMc7a9bWe6zFVAzbjsIeFuW2_IY/edit?usp=sharing") end,
	["/cert"] = function(ply) OpenURL(ply,"https://docs.google.com/spreadsheets/d/12bVhYKzwn4M0TMgrOMc7a9bWe6zFVAzbjsIeFuW2_IY/edit?usp=sharing") end,
	...
	["!rprequest"] = function(ply) return handleRPRequestCommand(ply) end,
	["/erprequest"] = function(ply) return handleRPRequestCommand(ply) end,
	["!erprequest"] = function(ply) return handleRPRequestCommand(ply) end,
...
DivisionTypes = {
    ["Cult Mechanicus Conclave"] = {
        ...
        Classes = {
            ...
            },
			{
                ...
                Default = false,
                Core = true,
                Models = {"models/wk/gibus/gibus_dominator.mdl"},
                ForceModels = true,
                Weapons = {"cat_legacy_gravgun"},
                MaxHealth = 400,
				PowerShield = true,
    ...
    ["Adeptus Astra Telepathica"] = {
        ...
        Description = "Psykers of the Imperium",
        Team = "imperium",
		Ranks = {
		    ...
		    {ID = 8, Name = "Scholar", Rank_Prefix = "Scholar", ModelsAllowed = PYSKER_MODELS, WeaponsAllowed = {}, CanPromote = true},
		    {ID = 9, Name = "Scholar Obscurus", Rank_Prefix = "Scholar Obscurus", ModelsAllowed = PYSKER_MODELS, WeaponsAllowed = {}, CanPromote = true},
		    {ID = 10, Name = "Dominus", Rank_Prefix = "Dominus", ModelsAllowed = PYSKER_MODELS, WeaponsAllowed = {}, CanPromote = true},
		    {ID = 11, Name = "Philosopher", Rank_Prefix = "Philosopher", ModelsAllowed = PYSKER_MODELS, WeaponsAllowed = {}, CanPromote = true}
		},
        Classes = {
            {
    ...
    ["11th Cadian Storm Guards"] = {
        ...
        Ranks = {
            ...
            {ID = 3, Name = "Senior Guardsman", Rank_Prefix = "SGDS", ModelsAllowed = CADIAN_MODELS, WeaponsAllowed = CADIAN_WEAPONS, CanPromote = true},
            {ID = 4, Name = "Veteran Guardsman", Rank_Prefix = "VGDS", ModelsAllowed = CADIAN_MODELS, WeaponsAllowed = CADIAN_WEAPONS, CanPromote = true},
            {ID = 5, Name = "Lance Corporal", Rank_Prefix = "LCPL", ModelsAllowed = CADIAN_MODELS, WeaponsAllowed = CADIAN_WEAPONS, CanPromote = true},
            {ID = 6, Name = "Specialist", Rank_Prefix = "SPC", ModelsAllowed = CADIAN_MODELS, WeaponsAllowed = CADIAN_WEAPONS, CanPromote = true},
            {ID = 7, Name = "Corporal", Rank_Prefix = "CPL", ModelsAllowed = CADIAN_MODELS, WeaponsAllowed = CADIAN_WEAPONS, CanPromote = true},
            {ID = 8, Name = "Sergeant", Rank_Prefix = "SGT", ModelsAllowed = CADIAN_MODELS, WeaponsAllowed = CADIAN_WEAPONS, CanPromote = true},
            {ID = 9, Name = "Colour Sergeant", Rank_Prefix = "CSGT", ModelsAllowed = CADIAN_MODELS, WeaponsAllowed = CADIAN_WEAPONS, CanPromote = true},
            {ID = 10, Name = "Sergeant Major", Rank_Prefix = "SGTM", ModelsAllowed = CADIAN_MODELS, WeaponsAllowed = CADIAN_WEAPONS, CanPromote = true},
            {ID = 11, Name = "Warrant Officer", Rank_Prefix = "WO", ModelsAllowed = CADIAN_MODELS, WeaponsAllowed = OFFICER_WEAPONS, CanPromote = true},
            {ID = 12, Name = "Lieutenant", Rank_Prefix = "LT", ModelsAllowed = CADIAN_MODELS, WeaponsAllowed = OFFICER_WEAPONS, CanPromote = true},
            {ID = 13, Name = "Captain", Rank_Prefix = "CPT", ModelsAllowed = CADIAN_MODELS, WeaponsAllowed = OFFICER_WEAPONS, CanPromote = true},
        },
        Classes = {
            {
                Name = "Guardsman",
    ...
    ["236th Death Korps of Krieg"] = {
        ...
        Ranks = {
            ...
            {ID = 3, Name = "Senior Korpsman", Rank_Prefix = "SKRP", ModelsAllowed = KRIEG_MODELS, WeaponsAllowed = KRIEG_WEAPONS, CanPromote = false},
			{ID = 4, Name = "Veteran Korpsman", Rank_Prefix = "VKRP", ModelsAllowed = KRIEG_MODELS, WeaponsAllowed = CADIAN_WEAPONS, CanPromote = false},
            ...
            {ID = 11, Name = "Warrant Officer", Rank_Prefix = "WO", ModelsAllowed = KRIEG_OFFICER, WeaponsAllowed = OFFICER_WEAPONS, CanPromote = true},
            {ID = 12, Name = "Lieutenant", Rank_Prefix = "LT", ModelsAllowed = KRIEG_OFFICER, WeaponsAllowed = OFFICER_WEAPONS, CanPromote = true},
            {ID = 13, Name = "Kaptain", Rank_Prefix = "KPT", ModelsAllowed = KRIEG_OFFICER, WeaponsAllowed = OFFICER_WEAPONS, CanPromote = true},
        },
        Classes = {
            {
                Name = "Guardsman",
        ...
        Classes = {
            {
        		...
        		vehicles = { 
								{ name = "Jeep", entityname = "lvs_wheeldrive_dodwillyjeep", description = "It's a Jeep", type = "Transport" },	
							},
			},
        },
        Ranks = {

...
DivisionTypes = {
    ...
    ["British Division"] = {
        ...
        Classes = {
            ...
            },
            {
                ...
                AllowedWeaponFlags = { "Submachine Gun", "Shotgun", "Rifle", "Side Arm" },
                Prefix             = "ST",
                Max                = 2,
                EntitySpawner = {
                    { name = "Gas Mask", entityname = "item_sh_gasmask", description = "Protects against gas attacks.", type = "Equipment" },
    ...
    ["German Division"] = {
        ...
        Ranks = {
			...
			{ ID = 5,  Name = "Sergeant",       Rank_Prefix = "SGT",  ModelsAllowed = GERMAN_MODELS, WeaponsAllowed = GERMAN_LOADOUT, CanPromote = true  },
            { ID = 6,  Name = "Unteroffizier",  Rank_Prefix = "UO",   ModelsAllowed = GERMAN_MODELS, WeaponsAllowed = GERMAN_LOADOUT, CanPromote = true  },
            { ID = 7,  Name = "Feldwebel",      Rank_Prefix = "FW",   ModelsAllowed = GERMAN_MODELS, WeaponsAllowed = GERMAN_LOADOUT, CanPromote = true  },
            { ID = 8,  Name = "Oberfeldwebel",  Rank_Prefix = "OFW",  ModelsAllowed = GERMAN_MODELS, WeaponsAllowed = GERMAN_LOADOUT, CanPromote = true  },
			{ ID = 9,  Name = "Officer Cadet",  Rank_Prefix = "OC",   ModelsAllowed = GERMAN_MODELS, WeaponsAllowed = GERMAN_LOADOUT, CanPromote = true  },

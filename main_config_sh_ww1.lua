...
DivisionTypes = {
    ...
    ["British Division"] = {
        ...
        Ranks = {
            ...
            { ID = 7,  Name = " Sergeant",         Rank_Prefix = "SSGT",    ModelsAllowed = BRITISH_MODELS, WeaponsAllowed = BRITISH_LOADOUT, CanPromote = true  },
    ...
    ["American Expeditionary Forces"] = {
        ...
        Ranks = {
            ...
            { ID = 5,  Name = " Sergeant",      Rank_Prefix = "SSG", ModelsAllowed = BRITISH_MODELS, WeaponsAllowed = US_LOADOUT, CanPromote = true  },

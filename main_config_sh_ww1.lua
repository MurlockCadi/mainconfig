...
DivisionTypes = {
    ...
    ["British Division"] = {
        ...
        Ranks = {
            ...
            { ID = 9,  Name = "Second Lieutenant",      Rank_Prefix = "2LT",     ModelsAllowed = BRITISH_MODELS, WeaponsAllowed = BRITISH_LOADOUT, CanPromote = true  },
            { ID = 10, Name = "Lieutenant",             Rank_Prefix = "LT",      ModelsAllowed = BRITISH_MODELS, WeaponsAllowed = BRITISH_LOADOUT, CanPromote = true  },
            { ID = 11, Name = "Captain",                Rank_Prefix = "CPT",     ModelsAllowed = BRITISH_MODELS, WeaponsAllowed = BRITISH_LOADOUT, CanPromote = true  },
            { ID = 12, Name = "Major",                  Rank_Prefix = "MAJ",     ModelsAllowed = BRITISH_MODELS, WeaponsAllowed = BRITISH_LOADOUT, CanPromote = true  },
            { ID = 13, Name = "Colonel",                Rank_Prefix = "COL",     ModelsAllowed = BRITISH_MODELS, WeaponsAllowed = BRITISH_LOADOUT, CanPromote = true  },
        },
        Classes = {
            {
                Name               = "Rifleman",
    ...
    ["German Division"] = {
        ...
        Ranks = {
            ...
            { ID = 5,  Name = "Unteroffizier",  Rank_Prefix = "UO",   ModelsAllowed = GERMAN_MODELS, WeaponsAllowed = GERMAN_LOADOUT, CanPromote = true  },
            { ID = 6,  Name = "Feldwebel",      Rank_Prefix = "FW",   ModelsAllowed = GERMAN_MODELS, WeaponsAllowed = GERMAN_LOADOUT, CanPromote = true  },
            { ID = 7,  Name = "Oberfeldwebel",  Rank_Prefix = "OFW",  ModelsAllowed = GERMAN_MODELS, WeaponsAllowed = GERMAN_LOADOUT, CanPromote = true  },
            { ID = 8,  Name = "Leutnant",       Rank_Prefix = "LT",   ModelsAllowed = GERMAN_MODELS, WeaponsAllowed = GERMAN_LOADOUT, CanPromote = true  },
            { ID = 9,  Name = "Oberleutnant",   Rank_Prefix = "OLT",  ModelsAllowed = GERMAN_MODELS, WeaponsAllowed = GERMAN_LOADOUT, CanPromote = true  },
            { ID = 10, Name = "Hauptmann",      Rank_Prefix = "HPT",  ModelsAllowed = GERMAN_MODELS, WeaponsAllowed = GERMAN_LOADOUT, CanPromote = true  },
            { ID = 11, Name = "Major",          Rank_Prefix = "MAJ",  ModelsAllowed = GERMAN_MODELS, WeaponsAllowed = GERMAN_LOADOUT, CanPromote = true  },
            { ID = 12, Name = "Oberstleutnant", Rank_Prefix = "OBTL", ModelsAllowed = GERMAN_MODELS, WeaponsAllowed = GERMAN_LOADOUT, CanPromote = true  },
            { ID = 13, Name = "Oberst",         Rank_Prefix = "OBT",  ModelsAllowed = GERMAN_MODELS, WeaponsAllowed = GERMAN_LOADOUT, CanPromote = true  },
        },
        Classes = {
            {
                Name               = "Rifleman",
            ...
            },
            {
                ...
                Prefix             = "AV",
                vehicles = {
                    { name = "Fokker Dr.I",     entityname = "lunasflightschool_fokkertrigreen", description = "German Plane, often known simply as the Fokker Triplane.", type = "Plane" },
                    { name = "Fokker Dr.I Red", entityname = "lunasflightschool_fokkertrired",   description = "HIGHER, THE KING OF THE SKY",                              type = "Plane" },
                },
            },
            {
                Name               = "Cavalry",

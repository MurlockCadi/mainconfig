--[[
    ============================================================
    IMPERIUM GAMING - VIETNAM JUNGLE WARFARE RP
    Main Server Configuration File
    ============================================================
    MANAGED AT: https://github.com/MurlockCadi/mainconfig/blob/main/main_config_sh_vietnam.lua
...
mapMessage_default = "Somewhere during the height of the Vietnam War..."
...
US_PILOT_MODELS = {
    "models/hitboxedit/us/army/us_pilot_1.mdl",
    "models/hitboxedit/us/army/us_pilot_2.mdl",
...
VIETCONG_MODELS = {
    "models/hitboxedit/vietnam/humans/vc/gmod/vc_1.mdl",
    "models/hitboxedit/vietnam/humans/vc/gmod/vc_2.mdl",
    "models/hitboxedit/vietnam/humans/vc/gmod/vc_3.mdl",
    "models/hitboxedit/vietnam/humans/vc/gmod/vc_4.mdl",
    "models/hitboxedit/vietnam/humans/vc/gmod/vc_5.mdl",
}

PAVN_MODELS = {
    "models/hitboxedit/player/pavn_infantry.mdl",
...
-- Reused across multiple division Engineer/Logistics classes.
-- ============================================================

local STANDARD_FORTIFICATIONS = {
...
DivisionTypes = {
    ...
    ["US Marines"] = {
        ...
        Classes = {
            ...
            },
            {
                ...
                Prefix             = "DOC",
                EntitySpawner = {
                    { name = "Medical Box", entityname = "medic_box", description = "Grants you XP when used by your teammates!", type = "Medic Box" },
                },
            },
            {
                Name               = "Logistics",
                ...
                AllowedWeaponFlags = { "Rifle", "Side Arm", "Submachine Gun", "Shotgun" },
                Prefix             = "LOG",
                Fortifications     = STANDARD_FORTIFICATIONS,
                EntitySpawner = {
                    ...
                    { name = "Petrol",           entityname = "lvs_item_jerrycan",      description = "Used to refuel your vehicles on the frontlines!", type = "Ammo" },
                    { name = "Diesel",           entityname = "lvs_item_jerrycan_diesel",description = "Used to refuel your vehicles on the frontlines!", type = "Ammo" },
                },
                vehicles = {
                    { name = "M151 Mutt",             entityname = "lvs_wheeldrive_m151mutt",         description = "Light 4x4 utility vehicle, used for reconnaissance and transport of small squads.",                                                                     type = "Small Vehicle"  },
                    { name = "M35 Infantry Truck",    entityname = "lvs_wheeldrive_m35inf",            description = "Medium 6x6 truck, used for transporting troops and supplies across the battlefield.",                                                                    type = "Small Vehicle"  },
                    { name = "M113 APC",              entityname = "lvs_wheeldrive_m111",              description = "Sturdy armored personnel carrier, used for safely transporting infantry squads and providing support with its mounted machine gun.",                     type = "APC"            },
                    { name = "M113 APC (Mobile Outpost)", entityname = "lvs_wheeldrive_m111_mobile_outpost", description = "Sturdy armored personnel carrier with a mobile outpost, used for safely transporting infantry squads and providing support with its mounted machine gun.", type = "Mobile Outpost" },
                },
            },
            {
                Name               = "Tanker",
                ...
                vehicles = {
                    { name = "M47 Patton",   entityname = "lvs_wheeldrive_m47",  description = "Medium tank with a powerful 90mm gun, used for engaging enemy armor and providing fire support to infantry units.",                                                                          type = "Heavy Tanks" },
                    { name = "M551 Sheridan",entityname = "lvs_wheeldrive_m551", description = "Light tank with a versatile 152mm gun, capable of firing both conventional shells and guided missiles, used for reconnaissance and engaging a variety of targets on the battlefield.", type = "Light Tanks" },
                },
            },
            {
                Name               = "Marksman",
    ...
    ["US Army"] = {
        ...
        Ranks = {
            { ID = 1,  Name = "Private",            Rank_Prefix = "PVT",   ModelsAllowed = US_MODELS, WeaponsAllowed = {}, CanPromote = false },
            { ID = 2,  Name = "Private First Class", Rank_Prefix = "PFC",  ModelsAllowed = US_MODELS, WeaponsAllowed = {}, CanPromote = false },
            { ID = 3,  Name = "Specialist",          Rank_Prefix = "SPC",  ModelsAllowed = US_MODELS, WeaponsAllowed = {}, CanPromote = false },
            { ID = 4,  Name = "Corporal",            Rank_Prefix = "CPL",  ModelsAllowed = US_MODELS, WeaponsAllowed = {}, CanPromote = true  },
            { ID = 5,  Name = "Sergeant",            Rank_Prefix = "SGT",  ModelsAllowed = US_MODELS, WeaponsAllowed = {}, CanPromote = true  },
            { ID = 6,  Name = "Staff Sergeant",      Rank_Prefix = "SSGT", ModelsAllowed = US_MODELS, WeaponsAllowed = {}, CanPromote = true  },
            { ID = 7,  Name = "Sergeant First Class",Rank_Prefix = "SFC",  ModelsAllowed = US_MODELS, WeaponsAllowed = {}, CanPromote = true  },
            { ID = 8,  Name = "Master Sergeant",     Rank_Prefix = "MSGT", ModelsAllowed = US_MODELS, WeaponsAllowed = {}, CanPromote = true  },
            { ID = 9,  Name = "First Sergeant",      Rank_Prefix = "1SGT", ModelsAllowed = US_MODELS, WeaponsAllowed = {}, CanPromote = true  },
            { ID = 10, Name = "Sergeant Major",      Rank_Prefix = "SGM",  ModelsAllowed = US_MODELS, WeaponsAllowed = {}, CanPromote = true  },
            { ID = 11, Name = "Second Lieutenant",   Rank_Prefix = "2LT",  ModelsAllowed = US_MODELS, WeaponsAllowed = {}, CanPromote = true  },
    ...
    ["National Liberation Front"] = {
        ...
        Ranks = {
            ...
            { ID = 8,  Name = "Thuong si nhat",    Rank_Prefix = "MSGT",  ModelsAllowed = VIETCONG_MODELS, WeaponsAllowed = {}, CanPromote = true  },
        ...
        Classes = {
            ...
            },
            {
                ...
                vehicles = {
                    { name = "GAZ-69", entityname = "lvs_wheeldrive_gaz69", description = "A light utility vehicle used for troop transport and reconnaissance missions.", type = "Small Vehicle" },
                },
            },
            {
                Name               = "Machine Gunner",
    ...
    ["Peoples Army of Vietnam"] = {
        ...
        Ranks = (function()
            local officer_model = { "models/hitboxedit/player/pavn_officer.mdl" }
            return {
                ...
                { ID = 8,  Name = "Thuong si nhat",    Rank_Prefix = "MSGT",  ModelsAllowed = PAVN_MODELS,    WeaponsAllowed = {}, CanPromote = true  },
                ...
                { ID = 11, Name = "Thieu uy",          Rank_Prefix = "2LT",   ModelsAllowed = officer_model,  WeaponsAllowed = {}, CanPromote = true  },
                { ID = 12, Name = "Trung uy",          Rank_Prefix = "1LT",   ModelsAllowed = officer_model,  WeaponsAllowed = {}, CanPromote = true  },
                { ID = 13, Name = "Dai uy",            Rank_Prefix = "CPT",   ModelsAllowed = officer_model,  WeaponsAllowed = {}, CanPromote = true  },
                { ID = 14, Name = "Thieu ta",          Rank_Prefix = "MAJ",   ModelsAllowed = officer_model,  WeaponsAllowed = {}, CanPromote = true  },
                { ID = 15, Name = "Trung ta",          Rank_Prefix = "LTCOL", ModelsAllowed = officer_model,  WeaponsAllowed = {}, CanPromote = true  },
                { ID = 16, Name = "Dai ta",            Rank_Prefix = "COL",   ModelsAllowed = officer_model,  WeaponsAllowed = {}, CanPromote = true  },
            }
        end)(),
        ...
        Classes = {
            ...
            },
            {
                ...
                Prefix             = "MD",
                EntitySpawner = {
                    { name = "Medical Box", entityname = "medic_box", description = "Used to let your soldiers heal themselves!", type = "Medic Box" },
                },
            },
            {
                Name               = "Machine Gunner",
            ...
            },
            {
                ...
                vehicles = {
                    { name = "GAZ-69",                entityname = "lvs_wheeldrive_gaz69",           description = "A light utility vehicle used for troop transport and reconnaissance missions.",              type = "Small Vehicle"  },
                    { name = "AA Truck",               entityname = "lvs_wheeldrive_aa_truck",        description = "A very old truck equipped with a light machine gun.",                                        type = "Small Vehicle"  },
                    { name = "GAZ-51",                 entityname = "lvs_wheeldrive_gaz51",           description = "Medium utility vehicle used for troop transport and logistics.",                             type = "Small Vehicle"  },
                    { name = "BTR-70",                 entityname = "lvs_wheeldrive_btr70",           description = "Armored personnel carrier used for safely transporting infantry squads.",                   type = "APC"            },
                    { name = "BTR-70 (Mobile Outpost)",entityname = "lvs_wheeldrive_btr70_mobile_outpost", description = "Armored personnel carrier with a mobile outpost, used for safely transporting infantry squads.", type = "Mobile Outpost" },
                },
            },
        },
    },
    ...
    ["Dac Cong"] = {
        ...
        Ranks = (function()
            local sf_model = { "models/hitboxedit/player/pavn_special_forces.mdl" }
            local ranks = {}
            local names = {
                { "Binh nhi", "PVT" }, { "Binh nhat", "PFC" }, { "Ha si", "SPC" }, { "Ha si nhat", "CPL" },
                { "Trung si", "SGT" }, { "Trung si nhat", "SSGT" }, { "Thuong si", "SFC" }, { "Thuong si nhat", "MSGT" },
                { "Sinh vien si quan", "1SG" }, { "Chuan uy", "SGM" },
                { "Thieu uy", "2LT" }, { "Trung uy", "1LT" }, { "Dai uy", "CPT" },
                { "Thieu ta", "MAJ" }, { "Trung ta", "LTCOL" }, { "Dai ta", "COL" },
            }
            for i, v in ipairs(names) do
                ranks[i] = { ID = i, Name = v[1], Rank_Prefix = v[2], ModelsAllowed = sf_model, WeaponsAllowed = {}, CanPromote = i >= 5 }
            end
            return ranks
        end)(),
        ...
        Classes = {
            ...
            },
            {
                ...
                Weapons            = {},
                HasParashoot       = true,
                SpawnWeapons       = { "fas2_ifak", "ent_spawner","hide_player" },
                AllowedWeaponFlags = { "Side Arm", "Shotgun", "Submachine Gun", "Rifle" },
                Prefix             = "MD",
                EntitySpawner = {
                    { name = "Medical Box", entityname = "medic_box", description = "Used to let your soldiers heal themselves!", type = "Medic Box" },
            ...
            },
            {
                ...
                Weapons            = {},
                HasParashoot       = true,
                SpawnWeapons       = {"ent_spawner","hide_player"},
                AllowedWeaponFlags = { "Side Arm", "Shotgun", "Submachine Gun", "Rifle", "Machine Gun" },
                Prefix             = "MG",
                EntitySpawner = {
                    { name = "DSHK",             entityname = "lvs_trailer_dshk_12mm",              description = "A heavy machine gun used for anti-aircraft and anti-vehicle purposes, often mounted on a tripod or vehicle.",           type = "Machine Gun" },
            ...
            },
            {
                ...
                Models             = {},
                Weapons            = {},
                SpawnWeapons       = { "weapon_lvsmines", "seal6-c4", "angry_swep_infantrymine", "angry_swep_m16mine","hide_player" },
                AllowedWeaponFlags = { "Side Arm", "Heavy Explosive", "Shotgun", "Submachine Gun", "Rifle" },
                Prefix             = "DEMO",
            },
            {
                ...
                Models             = { "models/hitboxedit/player/pavn_special_forces.mdl" },
                Weapons            = {},
                SpawnWeapons       = { "alydus_fortificationbuildertablet", "ent_spawner", "weapon_lvsrepair", "angry_swep_infantrymine", "outpost_maker", "murlock_rope_tool","hide_player" },
                AllowedWeaponFlags = { "Side Arm", "Shotgun", "Submachine Gun", "Rifle" },
                Prefix             = "LG",
                HasParashoot       = true,
                Fortifications     = STANDARD_FORTIFICATIONS,
...
ROLES = ROLES or {
    ...
    DIVISION_US_RECRUIT = {
        ...
        Prefix       = "",
        Color        = Color(0, 75, 32),
        Description  = "Drafted, volunteered, or forced — you have joined the war in Vietnam to fight for freedom and your country.",
        Default      = true,
    ...
    DIVISION_VIETCONG_BOT = {
        ...
        Bot          = true,
        Color        = Color(75, 0, 0),
        Description  = "Bots that fight for the Vietcong. Expendable. Fight to the death.",
        DefaultItems = {},
        Team         = "vietcong",
        Ranks = {
            { ID = 1, Name = "Conscript", Rank_Prefix = "Conscript", ModelsAllowed = VIETCONG_MODELS, WeaponsAllowed = {}, CanPromote = false },
        ...
        Classes = {
            { Name = "Conscript", Default = true, Models = VIETCONG_MODELS, Weapons = {}, SpawnWeapons = {}, Prefix = "" },
        },
    },
    ...
    DIVISION_US_BOT = {
        ...
        Bot          = true,
        Color        = Color(0, 75, 32),
        Description  = "Bots that fight for the US. Expendable. Fight to the death.",
        DefaultItems = {},
        Team         = "us",
        Ranks = {
            { ID = 1, Name = "Private", Rank_Prefix = "PVT", ModelsAllowed = US_MODELS, WeaponsAllowed = {}, CanPromote = false },
        ...
        Classes = {
            { Name = "Private", Default = true, Models = US_MODELS, Weapons = {}, SpawnWeapons = {}, Prefix = "" },
        },
    },
    ...
    DIVISION_DESERTER_BOT = {
        ...
        Description  = "Bots that fight for no one. Expendable. Fight to the death for themselves.",
        DefaultItems = {},
        Team         = "deserter",
        Ranks = {
        ...
        Classes = {
            { Name = "Deserter", Default = true, Models = { "models/hitboxedit/player/viet1.mdl" }, Weapons = {}, SpawnWeapons = {}, Prefix = "" },
        },
    },
}
